...
@app.route("/api/vi.0/percipitation") 
def precipitation(): 
    session = Session(engine) 
    ...
    percipitation_dict ={date: prcp for date, prcp in scores } 
...
@app.route(f"/api/vi.0/<start>") 
@app.route(f"/api/vi.0/<start>/<end>") 
